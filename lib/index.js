...
var Scheduler = (_temp = _class = function (_Component) {
    ...
    _createClass(Scheduler, [{
        ...
        value: function render() {
            ...
            var isReversed = width < config.reverseBreakpoint;
            ...
            if (showAgenda) {
                ...
                var resourceTableWidth = isReversed ? schedulerData.getSchedulerWidth() : schedulerData.getResourceTableWidth();
                var schedulerContainerWidth = isReversed ? schedulerData.getSchedulerWidth() : width - resourceTableWidth + 1;
                var schedulerWidth = isReversed ? schedulerData.getReversedContentTableWidth() : schedulerData.getContentTableWidth() - 1; // is reversed ? width- timetableWidth
                ...
                var resourceContentStyle = { overflowX: "auto", overflowY: "auto", width: isReversed ? null : resourceTableWidth + resourceScrollbarWidth - 2, margin: '0px -' + contentScrollbarWidth + 'px 0px 0px' };
                ...
                var resourceName = schedulerData.isEventPerspective ? config.taskName : isReversed ? config.resourceNameReversed : config.resourceName;
                tbodyContent = _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'resource-view__name', style: { overflow: "hidden", borderBottom: "1px solid #e9e9e9", height: isReversed ? '' : config.tableHeaderHeight } },
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'tr',
                                                { style: { height: isReversed ? '44px' : config.tableHeaderHeight } },
                                                _react2.default.createElement(
                                                    'th',
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'resource-view__list', style: resourceContentStyle, ref: this.schedulerResourceRef, onMouseOver: this.onSchedulerResourceMouseOver, onMouseOut: this.onSchedulerResourceMouseOut, onScroll: function onScroll() {
                                        return _this2.onSchedulerResourceScroll(isReversed);
                                    } },
                                _react2.default.createElement(_ResourceView2.default, _extends({
                                    isReversed: isReversed
                                }, this.props, {
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                { className: 'header-wrapper', style: {
                                        overflow: isReversed ? null : "hidden",
                                        borderBottom: "1px solid #e9e9e9",
                                        height: isReversed ? '' : config.tableHeaderHeight
                                    } },
                                _react2.default.createElement(
                                    'div',
                                    { style: { overflowX: isReversed ? null : "scroll", overflowY: "hidden", margin: '0px 0px -' + contentScrollbarHeight + 'px' }, ref: this.schedulerHeadRef, onMouseOver: this.onSchedulerHeadMouseOver, onMouseOut: this.onSchedulerHeadMouseOut, onScroll: this.onSchedulerHeadScroll },
                                    _react2.default.createElement(
                                        'div',
                                        { style: { paddingRight: contentScrollbarWidth + 'px', width: isReversed ? null : schedulerWidth + contentScrollbarWidth } },
                                        _react2.default.createElement(
                                            'table',
                                            { className: 'scheduler-bg-table scheduler-view__header' },
                                            _react2.default.createElement(_HeaderView2.default, _extends({ isReversed: isReversed }, this.props))
                                        )
                                    )
                                )
                            ),
                            _react2.default.createElement(
                                'div',
                                _defineProperty({ onScroll: this.handleScroll, style: schedulerContentStyle, ref: this.schedulerContentRef, onMouseOver: this.onSchedulerContentMouseOver, onMouseOut: this.onSchedulerContentMouseOut }, 'onScroll', function onScroll() {
                                    return _this2.onSchedulerContentScroll(isReversed);
                                }),
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'scheduler-bg', style: { overflow: 'hidden', width: isReversed ? null : schedulerContainerWidth } },
                                        _react2.default.createElement(
                                            'table',
                                            { className: 'scheduler-bg-table', style: { width: isReversed ? schedulerWidth : '9999px' }, ref: this.schedulerContentBgTableRef },
                                            _react2.default.createElement(_BodyView2.default, _extends({ isReversed: isReversed }, this.props))
                                        )
                                    )
                                )
                            )
            ...
            return _react2.default.createElement(
                'table',
                { id: 'RBS-Scheduler-root', className: 'scheduler ' + (isReversed ? 'scheduler-reverse' : ''), style: { width: width + 'px' } },
                _react2.default.createElement(
                    'thead',
                    null,
                    _react2.default.createElement(
    ...
    reverseAxis: _propTypes.PropTypes.bool
    ...
    this.onSchedulerResourceScroll = function (isReversed) {
        ...
        if (isReversed) {
            // Prevent onscroll loop
            if (!_this3.state.scrollingResource) {
                _this3.setState({
                    scrollingContent: true
                }, function () {
                    _this3.schedulerContent.scrollLeft = _this3.schedulerResource.scrollLeft;
                });
            } else {
                _this3.setState({
                    scrollingResource: false
    ...
    this.onSchedulerContentScroll = function (isReversed) {
        ...
        if (isReversed) {
            // Prevent onscroll loop
            if (!_this3.state.scrollingContent) {
                _this3.setState({
                    scrollingResource: true
                }, function () {
                    _this3.schedulerResource.scrollLeft = _this3.schedulerContent.scrollLeft;
                });
            } else {
                _this3.setState({
                    scrollingContent: false
