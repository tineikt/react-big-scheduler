...
var ResourceEvents = (_temp = _class = function (_Component) {
    ...
    _createClass(ResourceEvents, [{
        ...
        value: function render() {
            ...
            var cellWidth = this.props.isReversed ? config.columnReversedWidth : schedulerData.getContentCellWidth();
            var cellHeight = this.props.isReversed ? config.rowReverseHeight : null; // schedulerData.getContentCellWidth() : null;
            var cellMaxEvents = schedulerData.getCellMaxEvents();
            var rowWidth = this.props.isReversed ? schedulerData.getReversedContentCellWidth(resourceEvents.rowHeight) : schedulerData.getContentTableWidth();
                ...
                if (headerItem.count > 0 || headerItem.summary != undefined) {
                    ...
                    headerItem.events.forEach(function (evt, idx) {
                        if (idx < renderEventsMaxIndex && evt !== undefined && evt.render) {
                            ...
                            if (cellUnit === _index.CellUnits.Hour) {
                                _left = _left / schedulerData.getMinuteStepsInHour();
                                _width = _width / schedulerData.getMinuteStepsInHour();
                            }
                            var top = marginTop + idx * config.eventItemLineHeight;
                            var height = null;
                            if (_this2.props.isReversed) {
                                top = index * cellHeight;
                                _width = cellWidth - config.eventItemReversedMargin * 2;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    { style: { width: rowWidth, minWidth: this.props.isReversed ? rowWidth : null } },
