...
var HeaderView = (_temp = _class = function (_Component) {
    ...
    _createClass(HeaderView, [{
        ...
        value: function render() {
            ...
            var headerHeight = this.props.isReversed ? '' : schedulerData.getTableHeaderHeight();
            ...
            if (cellUnit === _index.CellUnits.Hour) {
                ...
                headers.forEach(function (item, index) {
                    if (index % minuteStepsInHour === 0) {
                        ...
                        style = !!item.nonWorkingTime ? { width: _this2.props.isReversed ? null : cellWidth, color: config.nonWorkingTimeHeadColor, backgroundColor: config.nonWorkingTimeHeadBgColor } : { width: _this2.props.isReversed ? '' : cellWidth };
                ...
                headerList = headers.map(function (item, index) {
                    ...
                    style = !!item.nonWorkingTime ? { width: _this2.props.isReversed ? '' : cellWidth, color: config.nonWorkingTimeHeadColor, backgroundColor: config.nonWorkingTimeHeadBgColor } : { width: _this2.props.isReversed ? '' : cellWidth };
